...
export const courseData: Course[] = [
  ...
  },
  {
    ...
    author: "Jane Smith",
    tags: ["#CareerPrep", "#LinkedIn", "#ResumeTips"],
    description: "Confused about where to go next? Let's chart out your short-term and long-term goals together.",
    features: [
  ...
  },
  {
    ...
    author: "Sam Wilson",
    tags: ["#CareerPrep", "#LinkedIn", "#ResumeTips"],
    description: "Practice your interview skills with real-time feedback. Choose tech, HR, or case-style interviews.",
    features: [
