...
import { AnimatedProfileColumn } from "./animated-profile-column";

export const AnimatedProfilesGrid = () => {
	...
	return (
		<div className="hidden lg:block relative h-[600px] overflow-hidden [mask-image:linear-gradient(to_bottom,black_80%,transparent_100%)]">
			<motion.div
				className="grid grid-cols-3 gap-8 h-full"
				onHoverStart={() => setIsAnimationPaused(true)}
				onHoverEnd={() => setIsAnimationPaused(false)}
			>
				<AnimatedProfileColumn
